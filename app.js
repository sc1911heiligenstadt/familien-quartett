  ...
  },
  {
    ...
    groups: [
      { title: "Wo die Spieldaten liegen", items: [
          "Die Spieldaten laufen über die Echtzeit-Datenbank von Google (Firebase). Das Rechenzentrum steht in Belgien, betrieben wird es von Google — nicht in Deutschland. Das gilt auch für hochgeladene Kartenfotos.",
          "Der Familien-Code ist das einzige Schloss vor euren Karten, Fotos und der Bestenliste. Wer ihn kennt oder errät, sieht alles davon — er gehört nur in die Familie und sollte nicht zu kurz sein.",
          "Wer seinen Namen nicht bei Google haben möchte, nimmt einen Spitznamen und lädt keine Fotos hoch."
      ]},
      { title: "Spielen", items: [
      ...
      { title: "Auf allen Geräten derselbe Stand", items: [
          "Die Kopfzeile zeigt an, ob die Verbindung zur Datenbank steht — „live“, wenn alles ankommt, „offline“ im Funkloch.",
